# Generated by Django 4.1.3 on 2023-02-01 05:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo2', models.ImageField(blank=True, null=True, upload_to='media', verbose_name='写真1')),
                ...
                ('photo3', models.ImageField(blank=True, null=True, upload_to='media', verbose_name='写真1')),
                ...
                ('photo4', models.ImageField(blank=True, null=True, upload_to='media', verbose_name='写真1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bussiness_hours_start', models.IntegerField(choices=[('１時', '１時'), ('2時', '2時'), ('3時', '3時'), ('4時', '4時'), ('5時', '5時'), ('6時', '6時'), ('7時', '7時'), ('8時', '8時'), ('9時', '9時'), ('10時', '10時'), ('11時', '11時'), ('12時', '12時'), ('13時', '13時'), ('14時', '14時'), ('15時', '15時'), ('16時', '16時'), ('17時', '17時'), ('18時', '18時'), ('19時', '19時'), ('20時', '20時'), ('21時', '21時'), ('22時', '22時'), ('23時', '23時'), ('24時', '24時')], default='選択してください', max_length=3, verbose_name='営業開始')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reservation_hour', models.CharField(choices=[('１時', '１時'), ('2時', '2時'), ('3時', '3時'), ('4時', '4時'), ('5時', '5時'), ('6時', '6時'), ('7時', '7時'), ('8時', '8時'), ('9時', '9時'), ('10時', '10時'), ('11時', '11時'), ('12時', '12時'), ('13時', '13時'), ('14時', '14時'), ('15時', '15時'), ('16時', '16時'), ('17時', '17時'), ('18時', '18時'), ('19時', '19時'), ('20時', '20時'), ('21時', '21時'), ('22時', '22時'), ('23時', '23時'), ('24時', '24時')], default='選択してください', max_length=3, verbose_name='予約時間')),
