# Generated by Django 4.1.3 on 2023-01-17 04:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holiday1', models.CharField(choices=[('mon', '月曜日'), ('tue', '火曜日'), ('wed', '水曜日'), ('thr', '木曜日'), ('fri', '金曜日'), ('sat', '土曜日'), ('sun', '日曜日'), ('cel', '祝日'), ('none', '無し')], default='cel', max_length=4, verbose_name='定休日1')),
                ('holiday2', models.CharField(choices=[('mon', '月曜日'), ('tue', '火曜日'), ('wed', '水曜日'), ('thr', '木曜日'), ('fri', '金曜日'), ('sat', '土曜日'), ('sun', '日曜日'), ('cel', '祝日'), ('none', '無し')], default='none', max_length=4, verbose_name='定休日2')),
                ('holiday3', models.CharField(choices=[('mon', '月曜日'), ('tue', '火曜日'), ('wed', '水曜日'), ('thr', '木曜日'), ('fri', '金曜日'), ('sat', '土曜日'), ('sun', '日曜日'), ('cel', '祝日'), ('none', '無し')], default='none', max_length=4, verbose_name='定休日3')),
                ('photo1', models.ImageField(blank=True, null=True, upload_to='', verbose_name='写真1')),
                ('photo2', models.ImageField(blank=True, null=True, upload_to='', verbose_name='写真2')),
                ('photo3', models.ImageField(blank=True, null=True, upload_to='', verbose_name='写真3')),
                ('photo4', models.ImageField(blank=True, null=True, upload_to='', verbose_name='写真4')),
